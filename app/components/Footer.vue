...
<footer class="bg-black">
    <div class="mx-auto w-full max-w-screen-xl">
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            <h2 class="text-white mb-6 text-sm font-semibold text-heading uppercase">Products</h2>
        ...
        <div>
            <h2 class="text-white mb-6 text-sm font-semibold text-heading uppercase">Blogs</h2>
            <ul class="text-body font-medium">
                <li class="mb-4">
        ...
        <div>
            <h2 class="text-white mb-6 text-sm font-semibold text-heading uppercase">Pages</h2>
            <ul class="text-body font-medium">
                <li class="mb-4">
        ...
        <div>
            <h2 class="text-white mb-6 text-sm font-semibold text-heading uppercase">Socials</h2>
            <ul class="text-body font-medium">
                <li class="mb-4">
